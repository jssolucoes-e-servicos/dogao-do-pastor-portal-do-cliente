...
interface NetworksStatisticsProps {
  networks: ICellNetwork[];
}
export function NetworksStatistics({networks}:NetworksStatisticsProps){
  return (
    <Fragment>
      <div className="grid gap-2 md:grid-cols-3 grid-cols-3">
       ...
       {/*  <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{networks.filter((c) => c.knowsChurch).length}</div>
